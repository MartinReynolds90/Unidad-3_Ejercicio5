...
public:
    ...
    Pelota(b2World* _world, RenderWindow* _wnd)
    {
        ...
        bodyDef.position.Set(0.0f, 0.0f); // Posición inicial del cuerpo físico
        ...
        fixtureDef.friction = 0.0f; // Fricción del cuerpo físico
        fixtureDef.restitution = 0.0f; // Restitución (elasticidad) del cuerpo físico
